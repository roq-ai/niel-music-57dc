...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Music', path: '/music', entity: 'music', service: AccessServiceEnum.PROJECT, icon: FiMusic },
    { name: 'Playlist', path: '/playlists', entity: 'playlist', service: AccessServiceEnum.PROJECT, icon: FiList },
    {
      name: 'Playlist Music',
